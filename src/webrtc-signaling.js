...
const { getUserById, getUserByUsername, areMutualFollowers, getRoomChannel, getOAuthToken, createNotification } = require('./db');
...
module.exports = { initSignaling, getOnlineUsers, getUserPresence, getVoiceChannelMembers, cancelPendingCallByToken };
