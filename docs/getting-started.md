...
2. **Sign up** (`/register`) — usernames are 3–20 letters, numbers, or underscores; passwords at least 12 characters and at most 72 bytes (multi-byte characters such as emoji count more).
